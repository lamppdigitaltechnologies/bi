...
<p class="book-appt"><a href="https://baazimmigration.cliogrow.com/book" target="_blank">Book Appointment</a></p>
	<header id="masthead" class="site-header hide-header-search" [class]="searchVisible ? 'show-header-search site-header ' : 'hide-header-search site-header'">
<!--<div class="top-header-contain mobile-only rcic-approved">
					<div class="wrapper">
...
-->
	...
	<!-- Mobile Scroll Menu -->
		<div id="m-s-m">
		 <ul id="mobile-scroll-menu">
		<li><a href="https://baazimmigration.ca">Home</a></li>
		<li><a href="https://baazimmigration.ca/about/">About</a></li>
		<li><a href="https://baazimmigration.ca/study/">Student Visa</a></li>
		<li><a href="https://baazimmigration.ca/super-visa/">Super Visa</a></li>
		<li><a href="https://baazimmigration.ca/visit/">Visitor Visa</a></li>
		<li><a href="https://baazimmigration.ca/work/">Work Permit</a></li>
		<li><a href="https://baazimmigration.ca/express-entry/">Express Entry</a></li>
		<li><a href="https://baazimmigration.ca/provincial-nominees/">Provincial Nominees (PNP)</a></li>
		<li><a href="https://baazimmigration.ca/citizenship/">Citizenship</a></li>
		<li><a href="https://baazimmigration.ca/contact-us/">Contact Us</a></li>
		</ul>   
		</div>
	<!-- Mobile Scroll Menu Ends-->
	...
	if ( $site_url == "https://baazimmigration.ca") {
		if ( is_front_page() ) {
	?>	
	<!--	<div id="header_slide">
			<div class="baaz-black-effect">
				<div id="header_slide_headline">
				<h1><span class="b1">B</span><span class="b2">a</span><span class="b1">a</span><span class="b2">z</span><span class="b1"> I</span><span class="b2">m</span><span class="b1">m</span><span class="b2">i</span><span class="b1">g</span><span class="b2">r</span><span class="b1">a</span><span class="b2">t</span><span class="b1">i</span><span class="b2">o</span><span class="b1">n</span></h1>
						
						<!--<p>Experience The New Reality</p>-->
					<!--	<p>Regulated Canadian Immigration Consultant</p>
		<p class="mobile-only">Member Of ICCRC</p>
						<a href="https://form.baazimmigration.ca/" class="btn btn-transparent page-scroll">Request a Call</a>
				</div>
			</div>
...
<video width="1920" autoplay="" muted="" loop="" playsinline="" id="hero-background-video" aria-hidden="true">
  <source src="https://baazimmigration.ca/wp-content/uploads/sequence-01.mp4" type="video/mp4">
</video>   
		</div>
<div class="content-video">
  <h1 class="video-title__headline"><span>Baaz</span> Immigration</h1>
  <p>Regulated Canadian Immigration Consultant</p>

	<!--<button id="myBtn" class="button button__white button-video">The Future is Here</button> -->
	<a href="https://form.baazimmigration.ca/"><button class="button button__white stat-button-link">Apply</button></a> 
	<a target="_blank" href="https://college-ic.ca/protecting-the-public/find-an-immigration-consultant"><button class="button button__white stat-button-link">Verify Us</button></a>
</div>
</div>
	<?php
		}
